...
namespace AwesomeSauce.Server
{
    public class AwesomeServer : IServer
    {
        public AwesomeServer(IOptions<AwesomeServerOptions> options)
        {
            ...
            var serverAdressesFeature = new ServerAddressesFeature();
            serverAdressesFeature.Addresses.Add(options.Value.FolderPath);
            Features.Set<IServerAddressesFeature>(serverAdressesFeature);
        }
